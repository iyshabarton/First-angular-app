  ...
  createDb() {
    const products = [
      ...
      },
      {
        ...
        imageUrl:
          'https://azwecdnepstoragewebsiteuploads.azureedge.net/PHO_BIKE_90_RE_norden901-90-right-my2021_%23SALL_%23AEPI_%23V1.png',
        price: 14749,
      },
      {
        id: 3,
        ...
        imageUrl:
          'https://azwecdnepstoragewebsiteuploads.azureedge.net/PHO_BIKE_90_RE_1290-sdr-evo-22-wh-90re_%23SALL_%23AEPI_%23V1.png',
        price: 20749,
      },
      {
        id: 4,
        ...
        imageUrl:
          'https://azwecdnepstoragewebsiteuploads.azureedge.net/PHO_BIKE_90_RE_890-adv-r-21-90re_%23SALL_%23AEPI_%23V2.png',
        price: 14949,
      },
      {
        id: 5,
        ...
        imageUrl:
          'https://images.triumphmotorcycles.co.uk/media-library/images/motorcycles/rocket%203/my22/rocket%203%20r/promo%20images/rocket-3-r-my22-korosi-red-rhs-955x537.jpg',
        price: 23900,
      },
      {
        id: 6,
        ...
        imageUrl:
          'https://images.triumphmotorcycles.co.uk/media-library/images/motorcycles/modern-classics/my21/street%20scrambler/base%20images/sandstorm%20edtion/sandstorm%20and%20matt%20urban%20grey/street-scrambler-sandstorm-smug-rhs-629.png',
        price: 11900,
      },
    ];
    return { products };
